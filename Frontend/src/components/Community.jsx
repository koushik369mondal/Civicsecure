...
function Community() {
  ...
  // Cleanup object URL for preview to avoid leaks
  useEffect(() => {
    return () => {
      if (newImagePreview) URL.revokeObjectURL(newImagePreview);
    };
  }, [newImagePreview]); // revoke created previews on unmount/change [web:26][web:35]
  ...
  }; // preview via object URL with cleanup [web:26][web:35]
  ...
  }; // properly revoke on reset [web:26][web:35]
  ...
  }; // reddit-like toggling votes for posts [web:28][web:25]
