              ...
              <form onSubmit={handleCreatePost}>
                <div className="mb-4">
                  <select
                    ...
                    className="w-full max-w-xs px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white text-gray-900"
                  >
                    {categories.map(cat => (
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent mb-4 bg-white text-gray-900"
                  required
                />
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent h-32 mb-4 bg-white text-gray-900 resize-none"
                  required
                />
                <div className="flex gap-2">
                  ...
                  <button type="button" onClick={() => setShowNewPost(false)} className="px-4 py-2 border border-gray-300 text-gray-900 hover:bg-gray-50 hover:border-gray-400 rounded-md font-medium transition-colors">
                    Cancel
                  </button>
                </div>
              </form>
