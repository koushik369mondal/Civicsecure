...
// import { schemesAPI } from "../services/api"; // Commented out until schemesAPI is implemented
...
// PDF files for scheme details
import awasYojanaPdf from "../assets/awas-yojna.pdf";
import digitalIndiaPdf from "../assets/digital-india.pdf";
import skillMissionPdf from "../assets/skill-mission-india.pdf";
...
function InfoHub() {
    ...
    const defaultSchemes = useMemo(
        () => [
            ...
            },
            {
                ...
                title: "Skill India Mission",
                description:
                    "National initiative to enhance employability through skill development programs and training.",
                category: "Education",
    ...
    const loadSchemesData = async (forceRefresh = false) => {
        try {
            ...
            // Check if schemesAPI exists and has getSchemes method
            // Since schemesAPI is not yet implemented, we'll use default schemes
            // if (typeof schemesAPI !== 'undefined' && schemesAPI.getSchemes) {
